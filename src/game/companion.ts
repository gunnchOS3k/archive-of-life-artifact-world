...
export class Lifeling {
  ...
  update(dt: number, playerX: number, playerY: number, _companionState: CompanionState) {
  ...
  triggerReaction(type: string = 'celebrate') {
    this.emote = type;
    this.emoteTimer = 2;
  ...
  drawPreview(ctx: CanvasRenderingContext2D, companionState: CompanionState, size = 100) {
